...
<div>
    <main class="main">
        ...
        <section class="section-padding">
            <div class="container wow fadeIn animated">
                <h3 class="section-title mb-20"><span>Produits</span> Populaires</h3>
                <div class="carausel-6-columns-cover position-relative">
                    <div class="slider-arrow slider-arrow-2 carausel-6-columns-arrow" id="carausel-6-columns-2-arrows"></div>
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        @foreach ($populariesproducts as $popularyproduct)

                            <div class="product-cart-wrap small hover-up">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('details', ['slug' => $popularyproduct->slug]) }}">
                                            <img class="default-img" src="{{ $popularyproduct->image }}" alt="">
                                            <img class="hover-img" src="assets/imgs/shop/product-2-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-content-wrap">
                                    <h2><a href="{{ route('details', ['slug' => $popularyproduct->slug]) }}">{{ $popularyproduct->name }}</a></h2>
                                    <div class="rating-result" title="90%">
                                        <span>
                                        </span>
                                    </div>
                                    <div class="product-price">
                                        <span>${{ $popularyproduct->sale_price }} </span>
                                        <span class="old-price">${{ $popularyproduct->regular_price }}</span>
                                    </div>
                                </div>
                            </div>
