    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ajouter Slider</h5>
                ...
                <form method="post" class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" wire:model='top_title' wire:keyup='generateSlug' id="recipient-name" placeholder="Entrez le titre de haut">
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($image)
                            <img src="{{ $image->temporaryUrl() }}" alt="" width="200px" class="img-thumbnail">
                        @endif
                        <div class="form-group">
